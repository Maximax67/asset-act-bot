...
async def help_handler(message: Message) -> None:
    await message.answer(
        ...
        "2. Зчитує аркуш з підрозділами для отримання метаданих\n"
        "3. Генерує акти через API генератора документів"
        "4. Завантажує згенерований файл на Google Диск та дублює в телеграм\n\n"
        "<b>Команди:</b>\n"
